...
\cdot \infty, L_X)$. This technique will later be generalized
and encapsulated in the statement and proof of Lemma ~\ref{lem:sat-1}.
...
\hookrightarrow R_L$ induced by the inclusions $H^0(\sx, L_X)
\hookrightarrow H^0(\sx, L).$ By Riemann Roch, we see there is some
element $y_{1, 3} \in (R_L)_3$ with $\ord_{P_1}(y_{1, 3}) = -1,$ not
in the image of the inclusion $\iota$. We claim that there exist $a_
1, a_2 \in k$ and a degree 4 polynomial $f(x_1, x_2) \in k[x_1, x_2]$
such that
\begin{align*}
...
Generalized Max Noether Theorem from Voight and Zureick-Brown
\cite[Lemma 3.1.3]{vzb:stacky}. That is, the maps
\begin{align*}
	H^0(\sx, 3L) \otimes H^0(\sx, (n - 3)L) \rightarrow H^0(\sx, nL)
\end{align*}

\noindent
are surjective for $n \geq 4$. A relation of the form $a_1 x_1 y_{1,
