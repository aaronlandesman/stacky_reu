...
\sssec*{Idea of Proof:} To show $\supseteq$, we show that $T \subseteq \initial(I)$, which follows immediately from $(1)$ and $(2)$. Then, we show that $\subseteq$ follows from condition $(3)$ and the fact that no terms in $S$ can be contained in $\initial(I)$ because $(1)$ implies that $S$ is a basis.
...
\item[(c)] Let $\tau = \max(1,
	\max_{1 \leq i \leq m}(\deg(x_i)))$. Then, $R_\halfcan$ is generated over $R_\halfcan'$
