...
scheme-theoretically cut out by degree 2 equations. \todo{reword ``all such''}
...
log divisors \todo{reword}. For a stacky curve $\sx$ with coarse space $X$ and
...
\begin{question}
	...
	\item Voight and Zureick-Brown define \todo{reword}
