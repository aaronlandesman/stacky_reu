...
Recall the notation $L_X = \lfloor L \rfloor \in \di X$. We will deduce the structure of the log spin canonical ring $R_L$
...
We will come back to this example when checking a condition called
admissibility that we will need later. \todo{ref}
\end{example}
...
First, we present a definition of admissibility.
...
that $(\sx', \halfcan', J)$ is admissible where $J = \{2, 3\}$.
...
We see that $(\sx', \halfcan', J)$ immediately satisfies
...
collaboration. We thank Jorge Neves for pointing out the
...
also thank Brian Conrad, John Voight, and Shou-Wu Zhang for helpful comments on
