...
problem to one of finding primitives of cones; we then apply previous work on continued fractions to deduce these primitives.  We conclude this part of the problem, showing by dimension count, that these primitives induce all the generators of $R_L$ over $R_L$'.
