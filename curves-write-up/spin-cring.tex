...
If $\Delta > 0$, we first check that the theorem holds for $\halfcan_X$
by inductively adding in log points to the base case of $\halfcan_X'
= 0$. Then we check that it holds for $\halfcan$ by raising
