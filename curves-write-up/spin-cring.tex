...
\todo{Remark or paragraph on Gorenstein-ness}
``Orbifold canonical curves are projectively Gorenstein''
from an old result of Kei-ichi Watanabe. The spin case
follows from projective Cohen-Macaulay which follows from
projectively normal as seen when taking the complete
space of sections.
\todo{Robin: This is probably better fit in the introduction
than background. Per the reviewer, this is the primary
interest in taking the orbifold canonical class to be in
the form that we have. However, it seems strange in the current
place that I plopped it in.}
...
\begin{rem}
	The log canonical ring, defined to be the direct sum of the even graded pieces of the log spin canonical ring,
	is Gorenstein. It is Cohen Macaulay from \cite[Example 2.5(a)]{watanabe:some-remarks-concerning-demazure's-construction-of-normal-graded-rings}
	and then Gorenstein by \cite[Corollary 2.9]{watanabe:some-remarks-concerning-demazure's-construction-of-normal-graded-rings}.
	In particular, this tells us a log spin canonical curve, the projectivization of a log spin canonical ring,
	is projectively Gorenstein.
\end{rem}
...
\todo{Replace this notation with Hirzebruch--Jung fractions}
