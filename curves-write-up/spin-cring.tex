...
We will come back to this example in Example ~\ref{eg:base-0-377-adm}
when checking an admissibility condition that is defined later
(Definition ~\ref{defn:admissible}).
\end{example}
...
Again, we will come back to this example in Example
~\ref{eg:base-1-33-adm} to check admissibility.
\end{example}
