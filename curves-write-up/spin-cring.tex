...
If $\Gamma$ has no nonzero odd weight modular forms, then $\Gamma$ is generated in weight at most $6$ with relations in weight at most $12$. This follows in the case $g > 0$ from Voight and Zureick-Brown \cite[Theorem 1.4]{vzb:stacky} and in the case that $g = 0$ from \cite[Theorem 9.3.1]{vzb:stacky}. Note that when $g = 0$ the exceptional cases of \cite[Theorem 9.3.1]{vzb:stacky} do not occur because $\delta > 0$.

Furthermore, if $\Gamma$ has some nonzero odd weight modular form, then it must 
...
generated in degree at most $5$ with relations in degree at most $10$. In fact, it is not difficult to show $M(\Gamma)$ is generated in weight at most 4 with relations in weight at most 8 when the genus of the stacky curve associated to $\Gamma \backslash \BH^*$ is 0 or 1, as noted in Remark ~\ref{rem:cusp-generation-4}. Note that the exceptional cases in Tables ~\ref{table:g-1-exceptional} and ~\ref{table:g-0-exceptional} do not occur because $\Gamma$ has a cusp, so $\delta > 0$.
\end{example}
...
spin canonical ring $R_L$. This is similar to the case of genus 1
...
then $R_L$ is generated in weight at most 4. Since $\delta > 0$,
$L_X$ is effective. Additionally, $R_{L_X}$ is generated in weight 1,
...
Therefore, $R_L$ is generated in weight at most 4 with relations in
