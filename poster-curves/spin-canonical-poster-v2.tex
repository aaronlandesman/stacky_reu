...
\noindent
with multiplication corresponding to tensor product of
...
is generated in degree 1 with relations in degree 2 \cite[p. 157]{saint-donat:proj}. This has the pleasant 
...
\cite[Theorem 3.4]{reid:infinitesimal} when $g \geq 2$.
...
Let $\Gamma$ be a Fuchsian group, i.e., $\Gamma \backslash \BH$ has finite
area, and let $\sx$ be a stacky curve
associated to $\Gamma \backslash \BH$ with signature $\sigma
= (g; e_1, \ldots, e_r; \delta)$. 

Except in an explicit finite list of cases, the
ring of modular forms $M(\Gamma)$ is generated as a $\Bbbk$-algebra
...
generated in weight at most $5$ with relations in weight at most $10$. 
...
\hline
$d$ & $\lfloor dD \rfloor$ & $\deg \lfloor dD \rfloor$ &  $\dim H^0(X,\lfloor dD \rfloor)$  & $M_{2d}(SL_2(\BZ))$  \\ 
\hline
0& 0& 0&  1& 1 \\ 
1&$-\infty$&-1& 0&  0 \\  
