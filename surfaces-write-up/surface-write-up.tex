...
Suppose $X$ and $Y$ are schemes.  Let $D$ be a divisor on $X\times Y$ or more generally for $X$ bundles over $Y$.  Can  generated by $x_1, \ldots x_m$ and $y_1, \ldots, y_{m'}$ with ideal of relations generated by $f_1, \ldots, f_n$ and $g_1, \ldots g_{n'}$.  Then can we find a generators and relations for $X\times Y$ or more generally for $X$ bundles over $Y$?
\end{question}
An obvious obstruction to this is the fact that we critically used the fact that $\hirz_k$ has well-defined bi-degrees.  Unfortunately, in general $\Pic(X \times Y) \not \cong \Pic(X) \times \Pic(Y)$.
...
Given a scheme $X$ generated by $x_1, \ldots, x_m$ with ideal of relations generated by $f_1, \ldots, f_n$.  Then can we describe generators and relations of $X$ blown up at some point $P$?
\end{question}
...
Can we provide bounds on all minimal 
\end{question}
