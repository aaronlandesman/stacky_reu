...
stacky canoincal rings on $\bp^m$:
...
\todo{Aaron: State other notations used here. I think there are few enough that we can just do it in a paragraph or two at the end of the introduction here.}
\begin{convention}
...
\noindent
where $\alpha_i \in \bq$ and $D_i \in \di X$ is an irreducible divisor. When it is convenient to do so, we shall sometimes start the indexing at $0$, so that $i$ runs from $0$ to $n$.
\end{convention}
...
\todo{Throughout this section, include some more transition, explaining which lemmas are general and will be used again for hirzebruch surfaces and which lemmas will be used only for $\bp^m$.}
...
perspective of adding a copy of $\bz$ to the Picard group, as induced by
