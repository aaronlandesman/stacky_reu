...
\end{lem}
\begin{proof}
The proof follows by examining the exact sequence
\[
\begin{tikzcd}
...
many valuable conversations. We would like to thank Ken Ono and the
Emory University Number Theory REU for arranging our project and
for the great support that we have received. We also thank Peter
Landesman and Shou-Wu Zhang for offering helpful comments and
insights on this paper. Finally, we would like to acknowledge the
