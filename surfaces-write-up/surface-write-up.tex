...
initiated in \cite{hassett:classical-and-minimal-models}, which aims to describe log canonical models of the form \todo{Robin: define $\mathscr{M}_g$? Not sure what this is.}
\begin{align*}
...
For the remainder of this section, we will assume that $D_1, D_2, D_
3, D_4$ are distinct divisors with bi-degrees $(1, 0)$, $(1, 0)$, $(
0, 1), (0, 1)$ respectively with $D_i = V(f_i)$ for $1 \leq i \leq 4
$ with $f_i \in \sco(\bida_i, \bidb_i)$.

In order to achieve this condition on \todo{write ``this''}
