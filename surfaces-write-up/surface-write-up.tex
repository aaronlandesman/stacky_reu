...
\cite{hassett:classical-and-minimal-models}
...
The work in this paper also yields bounds for certain rings of Hilbert 
...
stable under the action of the symplectic group. While in general these 
quotients can be quite complicated spaces, in the case that the resulting 
quotient spaces are isomorphic to $\bp^m$ for some $m$, or some Hirzebruch 
surface, our main result gives a method for bounding the degree of 
generators and relations for the corresponding rings of Hilbert modular 
forms and Siegel modular forms. Namely, as in \cite{vzb:stacky}, one can 
port these modular form groups from the analytic category to the algebraic 
category, and then view the ring of modular forms as a certain stacky 
canonical ring on our underlying algebraic space.
\todo{include references}

\todo{Possibly keep or delete following example}
