...
sure to copy the ones stated below, and not copy these ones. Robin: thm-restate only allows you to restate earlier theorems and not later ones, so the main thms must appear numbered as 1.-}
\begin{thm}
