...
~\ref{sec:hirz} and define $\Te, \Tp$, and $\Tm$ as in Definition ~\ref{defn:t-defn}. Let each $D_i = V(f_i)$ where $f_i \in \sco(a_i, b_i)$.
Now suppose that $\{f_1, \ldots, f_n\}$ contains two independent 
