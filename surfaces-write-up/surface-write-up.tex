...
restriction. If either of the bidegrees of $D$ are negative,
then the canonical ring is concentrated in degree 0. If one of the
bidegrees is 0, say the first one is 0, then $R_D$ is isomorphic
to $R_{D'}$, where $D' \in \bq \otimes_\bq \di \bp^1$, 
where $D'$ can be written as a sum of divisors whose degrees
are multiples of the second bidegree of $D$. Since the case of
