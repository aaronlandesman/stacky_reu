...
basis for degree one rational functions on $\bp^m$.  This may necessitate the inclusion of ``Ghost Divisors'' $D_i$ with coefficients $\alpha_i = 0$. 
...
\noindent
span $H^0(\bp^m, dD)$ over $k$. Furthermore, functions 
...
a basis of $H^0(\bp^m,dD)$. Note that there $\binom{m+ \deg \lfloor dD \rfloor }{m}$
...
basis of degree 1 rational functions, and so all monomials in $f_0,\ldots, f_m$
...
about a k basis, so the fact that there is a d there doesn't really matter,
