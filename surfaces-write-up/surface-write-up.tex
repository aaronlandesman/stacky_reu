...
\todo{Is $\sigma = \omega$? If not I'm very confused, since I don't see $\sigma$ defined anywhere before or after
	but it seems like the key to the whole proof.
	\\
Peter: Oops, sorry, I changed some of the $\sigma$'s to $\omega$'s but clearly not all of them.  Maybe I should have used a macro...  I fixed the ones I saw, but let me know if you see any more $\sigma$'s popping up anywhere.
}
with $E$ of the form
