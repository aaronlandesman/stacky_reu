...
rings of Hilbert and Siegel modular forms parametrized by rational
Hilbert and Siegel modular surfaces.
See Section~\ref{sec:conc} for a potential approach for generalizing our results to arbitrary rational surfaces.
...
rings of some associated divisors on that given surface.
