...
In the case that $D = K_X$, the canonical divisor, the graded section ring is referred to as
...
One natural way to generalize of the classical result of Petri mentioned above
is to examine the section rings of stacky curves (i.e., smooth proper
geometrically connected 1-dimensional Deligne-Mumford
stacks over a field with a dense open subscheme).
Indeed,
...
stacky curves.
All rings of modular forms associated to Fuchsian groups can be realized as canonical rings of
such curves, and so the above work also yields insight into such rings
of modular forms.
Further, 
...
In addition to section rings of curves, section rings of certain higher dimensional
...
\end{align*}
%% TODO: replace \kappa_1 and \kappa_2 with two letters or use prod notation
