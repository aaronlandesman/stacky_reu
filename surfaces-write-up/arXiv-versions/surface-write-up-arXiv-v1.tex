...
as in Theorem ~\ref{thm:proj-effective-intro}. Write $\ell_i := \lcm
_{j \ne i}(k_j)$ and $a_i := \deg D_i$. Let $\bp^m \cong \proj
\bk[x_0, \ldots, x_m]$. Now suppose that $f_0, \ldots, f_n$ contain
$m$ independent linear polynomials in $x_0, \ldots, x_m$ (with possibly
zero coefficients $\alpha_j$).
...
cannot repreesnt equations of only $m$ of the $m+1$ coordinates.
\end{rem}
