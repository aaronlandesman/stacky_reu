...
\begin{block}{Goal}
Suppose $\Gamma$ is a congruent subgroup of $\SL_2(\BBZ)$ or more generally a Fuchsian group with finite quotient.  Then can we bound the degrees of generators and relations of $\overline{\Gamma \backslash \mathbb{H}}$?
\end{block}
...
\begin{itemize}
\item Let $X$ be the {\bf coarse space} of $\sx$
\end{itemize}
...
\end{block}
\begin{itemize}
\item The result of Voight and Zureick-Brown bounds generators and relations by 42 and 84 in the previous example.
\end{itemize}
...
\begin{itemize}
\item $M(\Gamma)$ is generated in degrees up to 6 with relations generated in degrees at most 12. 
\item If $\Gamma$ has a nonzero odd weight modular form, then $M(\Gamma)$ is
