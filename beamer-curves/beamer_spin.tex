...
% \begin{center}
  \begin{tikzpicture}
    ...
    %\filldraw[draw=black,fill=black] (1.5,0) node [below=2pt] {$\mu_{a_1}$} circle (1.5pt);
		...
		\filldraw[draw=black,fill=black] (-1.5,0) node [below=2pt]{$P_1$} circle (1.5pt);
		\filldraw[draw=black,fill=black] (0,0) node [below=2pt] {$P_2$} circle (1.5pt);
    \filldraw[draw=black,fill=black] (1.5,0) node [below=2pt] {$P_3$} circle (1.5pt);
