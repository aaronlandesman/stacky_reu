...
\begin{example}
When $\Gamma \subseteq SL_2(Z)$ is a congruence subgroup such that $\Gamma$ has an odd weight modular form, then we will prove that $M(\Gamma)$ is generated in degree at most 5 with relations generated in degree at most 10.
\end{example}
