...
directions. A divisor $\Delta \in \di X$ is a {\bf log divisor} if
...
{\bf log spin curve} is a triple $(\sx, \Delta, \halfcan)$ where $(\sx,\Delta)$
is a log stacky curve and $\halfcan$ is a log half-canonical divisor on $(\sx,\Delta)$.
...
\todo{Somewhere in the paper, we should probably give an example showing the generators and relations are sharply bounded at degree e, 2e.}
