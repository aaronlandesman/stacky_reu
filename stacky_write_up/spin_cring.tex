...
Then we find $2\halfcan$ equals (not just up to linear equivalence) something of the form $D+\sum \subhalf{i}P_i
...
the grlex monomial ordering $<$ on $k[x_1,\ldots, x_n]$. By
...
\begin{enumerate}
	...
	\item[(b)] Equip $k[y_3,y_4,y_5]$ with $grlex$ so that $y_3 \prec 
		y_4 \prec y_5$ and equip the ring $k[y_3,y_4,y_5,x]$ with the block 
