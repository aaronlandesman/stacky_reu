...
case which is done, with $\halfcan$ replaced by $K$, \todo{Peter: I don't think its helpful to say with $L$ replaced by $K$.  It might slightly confuse the reader into thinking that replacing half canonical divisor with canonical divisor changes the problem.} by Voight and
