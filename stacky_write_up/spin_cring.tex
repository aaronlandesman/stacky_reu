...
Let $\sx \rightarrow \sx'$ be a birational map of tame, separably rooted log stacky curves, ramified over $Q_1,\ldots, Q_r$ and let $J \subset \{1,
...
\begin{align*}
	\deg \lfloor e K_{\sx'} \rfloor \geq \eta(i)
\end{align*}
where
\begin{align*}
