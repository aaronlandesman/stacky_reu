...
We have that $K_{\sx'} \sim -(\infty) + \frac{1}{3} P_1 + \frac{3}{7}
...
\[
	H^0 (\sx', \lfloor 21 K_{\sx'} \rfloor) \otimes H^0 (\sx', \lfloor
	(d - 21) K_{\sx'} \rfloor) \twoheadrightarrow = H^0 (\sx', \lfloor
	d K_{\sx'} \rfloor)
\]

\noindent
is surjective whenever $\deg (\lfloor (d - 21) K_{\sx'} \rfloor)
\geq 0$. Also, $\sigma_2$ has saturation $s = 5$ as noted in
Subsection ~\ref{ssec:g_0_saturation}. Thus, $R'$ is generated up to
degree $21 + (s - 1) = 24$.
...
\noindent
so $R'$ must have some generators $x_{1, 3}, x_{1, 5}, x_{1, 7},
x_{1, 7}$. Let $(-ord_{P_1}(x_j), -ord_{P_2}(x_j), -ord_{P_3}(x_j))$
