...
Then 
\begin{itemize}
\item $R_{\halfcan}$ is generated over $R_{\halfcan'}$ by elements $y_1, \ldots, y_n$ such that $y_i$ lies in  
degree $d_i$ and has a pole at $P$ of degree $c_i$

\item If $I$ and $I'$ are the ideal of relations of $R_{\halfcan}$ and $R_{\halfcan'}$ respectively, then 
