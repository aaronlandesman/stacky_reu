...
specific case in fact generalizes to any $\mathbf{Q}$-divisor: $\sum
\frac{\alpha_i}{\beta_i} P_i$ for $\alpha_i,\beta_i\in \mathbf{N}$.  

To prove thisUsing induction, we can prove prove that $\halfcan$ is 
generated up to degrees $e$ with relations up to degree $2e$.  
O'Dorney \todo{Insert reference} proves 
