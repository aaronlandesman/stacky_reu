...
\begin{proof}
If $\Delta =0$, the result is immediate from Reid. Otherwise, if
...
\todo{Aaron, I tried to edit the following question, but it still seems a bit imprecise, and the question in particular is a bit of a long sentence.}
	\item In Subsection \ref{ssec:bounds-high-genus}, we reference 
		the work of Reid \cite[p. 35]{reid:infinitesimal}. We use his 
		proof of that the 
		...
		lemmas to add stacky points and obtain bounds of $e = \max(5,e_1, \ldots, e_r)$ and $2e$.  Reid in fact proves something slightly stronger: that in 
		...
		\begin{rem}\label{rem:reduce-3,6}
			...
			points of stabilizer order 3. However, perhaps in the non-stacky case, one may be able able to generalize the result of Reid \cite[p. 35]{reid:infinitesimal} to show that log spin canonical rings can be generated in degree at most 3 with relations in degree at most 6, apart from a well characterized list of exceptions.
			\end{rem}
