...
\caption{$d_i$ vs. $c_i$.  This figure shows the positive best lower approximations shown as $*$ and other lattice points shown in $o$ of $\frac{14}{5}$.  Note that they minimally generate lattice in $\mathbb{N}\times \mathbb{N}$ not above $5y=14x$.}
\end{figure}
