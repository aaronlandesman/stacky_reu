...
%uses best lower approximations to provide a minimal presentation for the canonical ring of an arbitrary $\BQ$-divisor $D = \frac{\alpha_1}{\beta_1}P_1 + \frac{\alpha_2}{\beta_2}P_2$ of $\BP_k^1$ with $\# \Supp(D) \leq 2$ and shows that it is generated in degree $e := \max(\beta_1, \beta_2)$ with relations generated in degrees at most $2e$ \cite[Section 4]{dorney:canonical}. For arbitrarily many points, O'Dorney also provides much larger bounds \cite[Section 5]{dorney:canonical}. While
%
...
%To do this, we extend a result by Voight and
