...
It will be useful to use lemma \ref{lem:minimal_quadratic} in the case $m=0$, in which case we find explicitly that $f_1, \ldots, f_r$ are $k$-minimal generators for $I'$ (over the trivial base vector space).  
\end{rem}
...
\begin{enumerate}
	...
	\item[(d)] $\sigma_4 = (0; 5, 7, 7; 0), J_4 = \{2, 3\}$
	\item[(e)] $\sigma_5 = (0; 7, 7, 7; 0), J_5 = \{1, 2, 3\}$
	\item[(f)] $\sigma_6 = (0; 3, 3, 3, 5; 0), J_6 = \{4\}$
	\item[(g)] $\sigma_7 = (0; 3, 3, 5, 5; 0), J_7 = \{3, 4\}$
	\item[(h)] $\sigma_8 = (0; 3, 5, 5, 5; 0), J_8 = \{2, 3, 4\}$
	\item[(i)] $\sigma_9 = (0; 5, 5, 5, 5; 0), J_9 = \{1, 2, 3, 4\}$
	\item[(j)] $\sigma_{10} = (0; 3, 3, 3, 3, 3; 0), J_{10} = \{1, 2, 3, 4, 5\}$
\end{enumerate}
\end{lem}
...
\begin{longtable}
	...
	(d) & \{3, 5, 5, 7, 7\} & \{10, 10, 12, 12, 14\}	& 7\\ \hline
	
	(e) & \{3, 5, 5, 7, 7, 7\} & \{10, 10, 10, 12, 12, 12, 14, 14, 14\}	& 7\\ \hline

	(f) & \{3, 3, 4, 5\} & \{8, 9\} & 5\\ \hline
	
	(g) & \{3, 3, 4, 5, 5\} & \{8, 8, 9, 9, 10\} & 5\\ \hline
	...
	(j) &	\{3, 3, 3, 4,	4, 5\} & \{6, 7, 7, 8, 8, 8, 9, 9, 10\} & 5\\ \hline
\end{longtable}
...
\begin{longtable}
	{| c | c || c | c | c |}
	\hline
	$\sigma$ & $J$ &  $i$ & $\deg \lfloor e_i L \rfloor$ & $\max_{d \geq 0} \#S_{(\sigma, J)}(i))$\\
	\hline
	\hline

	$(0; 3, 3, 11; 0)$ & $\{3\}$ & $\forall i \in J$ & 1 & 0\\	\hline
	
	$(0; 3, 7, 7; 0)$ & $\{3\}$ & $\forall i \in J$ & 2 & 0\\ \hline
	
	$(0; 5, 7, 7; 0)$ & $\{2, 3\}$ & $\forall i \in J$ & 2 & 0\\ \hline

	$(0; 7, 7, 7; 0)$ & $\{1, 2, 3\}$ & $\forall i \in J$ & 3 & 0\\ \hline

	$(0; 3, 3, 3, 5; 0)$ & $\{4\}$ & $\forall i \in J$ & 2 & 0\\ \hline
	
	$(0; 3, 3, 5, 5; 0)$ & $\{3, 4\}$ & $\forall i \in J$ & 3 & 0\\ \hline
	
	$(0; 3, 5, 5, 5; 0)$ & $\{2, 3, 4\}$ & $\forall i \in J$ & 4 & 0\\ \hline
	
	$(0; 5, 5, 5, 5; 0)$ & $\{1, 2, 3, 4\}$ & $\forall i \in J$ & 5 & 0\\ \hline

	$(0; 3, 3, 3, 3, 3; 0)$ & $\{1, 2, 3, 4, 5\}$ & $\forall i \in J$ & 5 & 0\\ \hline
\end{longtable}
