...
In order to do so, it is extermely useful to have a bound on the
...
Theorem ~\ref{thm:main} is proven seperately in the cases that the genus $g = 0, g = 1,$ and $g \geq 2$, each of
...
This is no restriction on generality, as generator and relation degrees are preserved under base change to the algebraic closue.
...
\begin{enumerate}
	\item One direction for further research is to 
		...
		Fractional modular forms also make an apperance in Milnor \cite[$
