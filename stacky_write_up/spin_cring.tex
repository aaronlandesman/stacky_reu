...
\todo{Extend Lemma \ref{lem:minimal:quadratic} to commutative diagrams to show minimality}
\end{proof}
...
\begin{enumerate}
	\item[(a)] $(\deg \lfloor e_3 L \rfloor, \max_{d \geq 0} \# S_{(
		\sigma_1, J_1)}(3)) = (1, 0)$

	\item[(b)] $(\deg \lfloor e_2 L \rfloor, \max_{d \geq 0} \#S_{(
		\sigma_2, J_2)}(2)) = (1, 0)$ \\
		$(\deg \lfloor e_3 L \rfloor, \max_{d \geq 0} \#S_{(\sigma_2, J_2)}(3))
		= (1, 0)$

	\item[(c)] $(\deg \lfloor e_1 L \rfloor, \max_{d \geq 0}
		\#S_{(\sigma_3, J_3)}(1)) = (2, 1)$ \\
		$(\deg \lfloor e_2 L \rfloor, \max_{d \geq 0}
		\#S_{(\sigma_3, J_3)}(2)) = (2, 1)$ \\
		$(\deg \lfloor e_3 L \rfloor, \max_{d \geq 0}
		\#S_{(\sigma_3, J_3)}(3)) = (1, 0)$

	\item[(d)] $(\deg \lfloor e_i  L \rfloor, \max_{d \geq 0}
		\#S_{(\sigma_4, J_4)}(i)) = (3, 1)$	for $i \neq 4$ \\
		$(\deg \lfloor e_4 L \rfloor, \max_{d \geq 0} \#S_{(\sigma_4, J_4)}(4))
		= (2, 0)$.

	\item[(e)] $(\deg \lfloor e_i L \rfloor, \max_{d \geq 0}
