...
We now state a lemma that allows us to inductively add rational multiples of a point to a divisor and describe the new generators and relations.
...
\]
and equip $k[y_1, \ldots, y_n]$ with graded P-revlex and $k[u, x_1, \ldots, x_m, y_1, \ldots, y_n]$ with block order \todo{it should be called block order, instead of ``a block order''}.
