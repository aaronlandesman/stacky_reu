...
\end{cor}
\begin{proof}
For $t \leq i \leq r$. Let $(\sx_i,\Delta, L_i)$ be the log stacky spin curve with the same coarse space as $L'$ and with the same stacky points as $(\sx',\Delta,L),$ having signature $(g;e_1, \ldots e_{i-1}, e_i, e_i, \ldots, e_i;\delta),$ and let 
...
\begin{proof}
By Lemma ~\ref{lem:generation_5} and Proposition ~\ref{prop:relation_11}, we are done in the case that there are no stacky points. 
\end{proof}
