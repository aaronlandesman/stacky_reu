...
\item $\deg(f) = \deg(g)$, $-\ord(f) = -\ord(g)$, and for $i$ maximal such that $q_i-r_i$ is non-zero, that expression is negative. \todo{I do not understand what this means, maximal under what ordering? Also, }
\end{enumerate}
\end{defn}
