...
defined by O'Dorney \todo{reference this-Section 1 of Evan's paper})
...
\begin{enumerate}
	...
	\item[(Ad-iii)] For all $i \in J$ we have
		\begin{align*}
			\deg \lfloor e_i L \rfloor \geq \# S_{\sigma, J}(i)
		\end{align*}
		where
		\begin{align*}
			S_{\sigma, J}(i) := \{j \in J : j \neq i \text{ and } e_j'+2d
			\mid e_i - e_j' \text{ for some } d \geq 0\}
		\end{align*}
\end{enumerate}
\end{defn}
