...
\todo{check admissibility}
\end{example}



\todo{remove stuff about tame and separably rooted, change to $\BQ$ divisor.}
Let $\sx$ be a tame, seperably rooted stacky curve of genus 1. Let $P,Q$ are distinct hyperelliptic fixed points, and $R_1,\ldots, R_n$ be points on $\sx$. In this section, will compute the canonical ring $R_{\halfcan'}$ in the cases that
\begin{enumerate}
	\item $\halfcan' = P-Q$
	\item $\halfcan' = 0$
	\item $\halfcan' = P-Q$
	\item $\halfcan' = P - Q + \frac{1}{3}R$
	\item $\halfcan' = P - Q + \frac{e-1}{2e}R, e > 3, e \equiv 1 \bmod 2$ 
	\item $\halfcan' = P - Q + \frac{1}{3}R_1 + \frac{1}{3}R_3$
\end{enumerate}
