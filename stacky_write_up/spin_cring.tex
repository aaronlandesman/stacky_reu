...
\]
and equip $k[y_1, \ldots, y_n]$ with graded Prevlex and $k[u, x_1, \ldots, x_m, y_1, \ldots, y_n]$ with block order \todo{it should be called block order, instead of ``a block order''}.
