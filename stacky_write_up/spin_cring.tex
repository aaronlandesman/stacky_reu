...
\]
\todo{Aaron: There is a small abuse of notation here: S is a set of monomials whereas $I$ is an ideal. Don't we really want to make clear that $S$ is a $k$ vector space? Alternatively, perhaps you want to talk about the monomials in $\initial(I)$ instead of all of the ideal}
Finally, note that
\[
