...
{dorney:canonical}. Voight and Zureick-Brown bounded the 
generator degrees by $3e$ and the relation degrees by $6e$ when
$\halfcan$ is effective \cite[Corollary 10.4.6]{vzb:stacky}.
...
field $k$, so that $\sx$ has signature $\sigma = (0; e_1, \ldots,
e_r; \delta)$.
