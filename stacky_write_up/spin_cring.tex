...
If $\sigma = (0; e_1, \ldots, e_r; 0)$ is not one of the
exceptional cases in Table ~\ref{table:g_0_exceptional} and $r \leq
5$, then $\sigma$ ``lies above'' one of the base cases of Lemma
~\ref{lem:g_0_admissible_cases}. In other words, one of the base
cases $(\sigma', J)$ with $\sigma' = (0; e_1', \ldots, e_r'; 0)$
satisfies the property that for all $i \in J$, $e_i \geq e_i'$ and
$e_i = e_i'$ otherwise. If $r > 5$, then we can use Lemma
...
this case satisfies all of the conditions by Lemma \todo{need this case
to satisfy conditions for adding points}, the
