...
O'Dorney's result \todo{cite theorem 8, Aaron: If you want to cite Theorem 8, just do \cite[Theorem 8]{dorney:canonical}} on $\BP^1_k$ to divisors $D = \sum_{i=1}^n \frac{\alpha_i
...
It is no coincidence that the proofs of Lemma ~\ref{lem:raise-stacky-orders} and \cite[Theorem 8.5.7]{vzb:stacky} are almost identical. In fact, the proofs of both results can easily be generalized generalized to the case of fractional canonical divisors, that is $L \in \di X$ with $nL \sim K$, for any $n \in \BZ_{\geq 1}$.
\end{rem}
