...
~\ref{lem:deg1-sat-ind}. When $\delta = 0$, the proof is a rather involved induction using Lemma
~\ref{lem:sat-three-induction-g-0} and Lemma ~\ref{lem:raise-stacky-order}.
...
particular choices of $J$ are admissible, we will use Lemmas ~\ref{lem:raise-stacky-order}, and ~\ref{lem:sat-three-induction-g-0} imply that the spin canonical ring
...
points via Lemma ~\ref{lem:sat-three-induction-g-0} and inductively raising
...
the Lemma ~\ref{lem:deg1-sat-ind} inductively on the classical case with no stacky points
...
~\ref{lem:sat-three-induction-g-0} to add stacky points with
