...
\todo{label/ref of long tables doesn't work!}
...
%	$(1; e; 0)$ & $\{2, 3, 5, 7, 9, \ldots, e\}$ & $\{12\} \cup \{9,10, \ldots, e+2, e+3, e+5, e+7, \ldots, 2e-4\}$ \\	\hline
\end{longtable}
\todo{Possibly add an autoincrement counter to deal with table numbering}
\todo{label/ref of long tables doesn't work!}
...
\begin{center}
Genus 0 saturation \todo{I see it says this above, but I think in the table, it should be made clear exactly what the hypotheses on $k,a,b,c,e_i$ are.}
\end{center}
