...
\end{thm}
\begin{proof}
Suppose $f \in I_L$ with $\deg f \geq 12$. To complete the proof, it suffices to show $f \in I_{L,d}'$. By Lemma ~\ref{lem:reducing degree}, it suffices to show $s_1g+s_2h \in I_{L,d}'$. 
