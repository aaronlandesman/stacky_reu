...
\max(5, e_1, \ldots, e_r).$ If the genus $g \geq 2,$ then $R(\sx,
\Delta, \halfcan)$ has relations in degree at most $\max(11, e_1,
\ldots, e_r).$ If the genus $g = 0$ or $g = 1,$ then $R(\sx, \Delta
, \halfcan)$ has relations in degree at most $\max(10, e_1, \ldots,
