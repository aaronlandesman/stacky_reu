...
$\Delta$. Furthermore, one may view stacky curves as stacks, in which case one only need assume that the stacky curve
...
Here we collect various definitions and useful notation that will be
...
The next step is to bound the degrees of the relations of $R_L$ when $\Delta > 0$. This is done in Proposition ~\ref{prop:relation-10}
