...
\label{ssec:add_pts}
In this section, we prove various inductive statements about
generators and relations with respect to adding points.
...
\ssec{Inductive Lemma: Raising Ramification Orders}
...
$R_{\halfcan'} \cong k[u,x,y_3,y_4]/(xy_3- \alpha uy_4,y_4^2 - \beta x^2 u - \gamma y^2u).$ The proof of this is fairly algorithmic, and analogous to that completed in Example ~\ref{ex:base-377}.
...
\ssec{Genus 1 Exceptional Cases}
...
\todo{fill in hole here, with adding points too}
