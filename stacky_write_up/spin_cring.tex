...
~\ref{rem:deg1_sat_ind}. When $\delta = 0$, this is not necessarily
true so the proof is a rather involved induction using Lemma
~\ref{lem:sat_three_ induction} and Theorem ~\ref{thm:ram_order_ind}.
...
of Lemma ~\ref{rem:deg1_sat_ind} are satisfied. Thus, we can apply
