...
\cong \proj R$ \todo{Peter: I'm confused.  Why is this only true when $g\geq 2$? Robin: see statement of Petri's theorem...}. When $g \geq 2$, Petri's theorem gives generators
...
\end{longtable}
\todo{Peter: Can we make a better description for the table above? Robin: Think of one.}
