...
Let's examine the case $2\halfcan\sim K_\sx+\Delta$ when $\Delta$ is a non-zero effective divisor.  
Then we find $2\halfcan$ equals (not just up to linear equivalence) something of the form $D+\sum \subhalf{i}P_i$ where $D\sim K_X+\Delta$ is a divisor of $X$ (i.e. with possibly negative integer coefficients).  Since $\Delta$ is non-zero effective, 
