...
Let $\sx$ be a tame, seperably rooted stacky curve of genus 1. Let $P,Q$ are distinct hyperelliptic fixed points, and $R_1,\ldots, R_n$ be points on $\sx$. \todo{cite genus 1 final theorem here, to explain what these cases are exceptional to} 

\todo{Why is there a pagebreak here}
...
Table ~\ref{table:g-1-exceptional}. By Remark ~\ref{rem:g-1-exceptional-e}, we only need explain how to obtain the signatures $(1;-;0),(1;3;0),(1;5;0).$ In the following example we will explain the case $\sigma = (1;5;0)$ as the other cases are even easier. 
