...
paper, it suffices to view $\sx$ as a scheme whose associated
divisor group allows a finite number of stacky points.
\todo{I don't know if this is a good statement to make.  We aren't
really viewing $\sx$ as a scheme.  Rather we're are determining 
information about its canonical rings through knowledge of scheme 
data.}

A {\bf log spin curve} is a triple $(\sx, \Delta, \halfcan)$ where
$\Delta \in \di X$ is an effective divisor and $2\halfcan = K _X +
