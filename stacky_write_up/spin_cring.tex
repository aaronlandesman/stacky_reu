...
literature. In particular, we use much of the notation from Voight
and Zureick-Brown. Here, we briefly present the definitions
and notation we use.
...
divisor associated with the coarse space $X$ of $\sx$, where
...
\]
\end{defn}
\todo{what about floors?}

\noindent
When the log spin curve is fixed, we usually use $R$ to represent
$R(\sx, \Delta, \halfcan)$. We also often use $H^0(\sx, D) :=
