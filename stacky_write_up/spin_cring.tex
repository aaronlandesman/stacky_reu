...
points via Lemma ~\ref{sat-three-induction-g-0} and by raising
...
~\ref{sat-three-induction-g-0} to add ramified points with
...
~\ref{sat-three-induction-g-0} (recall from Subsection ~\ref
{ssec:g_0_saturation} that saturation is 3 here), and the
immediate consequence of parts (a) and (c) of Lemma
~\ref{sat-three-induction-g-0} is that any $R(\sx', \Delta,
