...
\begin{align*}
	\frac{- ord_{Q_i}(z)}{\deg z} < \frac{e_i'-1}{2(e_i')}.
\end{align*}
...
\begin{align*}
	-\ord_{Q_i}(z) \leq \deg(z) \frac{e_i'-1}{2e_i'}-\frac{1}{e_i'}
\end{align*}
\end{lem}
\begin{proof}
We know by (Ad-ii) that
\begin{align*}
	-\ord_{Q_i}(z) < \deg(z) \frac{e_i'-1}{2e_i'}
\end{align*}
...
\begin{align*}
	-\ord_{Q_i}(z) \leq \deg(z) \frac{e_i'-1}{2e_i'} - \frac{1}{\beta} \leq \deg(z) \frac{e_i'-1}{2e_i'} - \frac{1}{e_i'}.
\end{align*}
\end{proof}
...
and
\begin{align*}
	\frac{-\ord_{Q_j}(y_{i,e_i'})}{y_{i,e_i}} \leq \frac{e_j'-1}{2e_j'}-\frac{1}{\deg(y_{i,e_i'})e_j'}
\end{align*}
...
\end{thm}
\begin{proof}
Let $(\sx,L)$ and $(\sx',L')$ be the two log stacky spin curves in question. Define
\begin{align*}
	S(i) = \{j \in J : j \neq i \text{ and }e_j' \mid e_i\}
\end{align*}
