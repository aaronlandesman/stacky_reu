...
satisfying $h^0(X, \lfloor{\halfcan'}\rfloor)\ge 1$. Suppose $P$ is not a base-point of $d\halfcan'$ for all $d\in \mathbf{N}^+$ meaning that $R_{\halfcan'}$ has generically chosen generators (in the necessary degrees)
...
\label{eqn:deg1_sat_ind_dim}
	...
	\rfloor) + \lfloor d\frac{\alpha} {\beta} \rfloor \text{ for all } d \in \mathbf{
