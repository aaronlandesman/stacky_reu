...
is called a \textbf{spin canonical divisor} on $(\sx, \Delta)$
and are sometimes referred to as theta-characteristics in other
literature. We also use $\halfcan_X$ to refer to the spin canonical
divisor (also known as the half-canonical divisor or semi-canonical
