...
\begin{example}
\label{eg:base-1-0}
Let $(\sx',0,\halfcan')$ be a log stacky curve of genus $g = 1$. In the case $\halfcan' = 0,$ it is immediately clear that $R_{\halfcan'} \cong k[x]$ with $x$ a generator in degree 1.
\end{example}
