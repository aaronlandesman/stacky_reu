...
Let $\Gamma$ be a {\bf Fuchsian} group, i.e. \todo{tilde?}a discrete subgroup of
...
We can now prove the first of three lemmas used to inductively add points.
\todo{Someone verify if this is a good fix. If someone thinks it's okay then remove this.}
...
\todo{replace *** with something else}
...
\todo{make clear what dash means}
